...
class opCode{
  ...
  boolean equals(String identity, int index){
    return (this.identity.equals(identity) && (this.index == index));
  }
  
}

opCode[] codes = {
   new opCode("ADD",     "100000", 0),
   new opCode("ADDI",    "------", -1),//BinaryCode wher!?!??!
   new opCode("ADDIU",   "001001", 26),
   new opCode("ADDU",    "100001", 0),
   new opCode("AND",     "100100", 0),
   ...
   new opCode("Break",   "001101", 0),
   new opCode("DADD",    "101100", 0),
   new opCode("DADDI",   "011000", 26),
   new opCode("DADDIU",  "011001", 26),
   new opCode("DADDU",   "101101", 0),
   new opCode("DIV",     "011010", 0),
   new opCode("DIVU",    "011011", 0),
   new opCode("DSLL",    "111000", 0),
   new opCode("DSLL32",  "111100", 0),
   new opCode("DSLLV",   "010100", 0),
   new opCode("DSRA",    "111011", 0),
   new opCode("DSRA32",  "111111", 0),
   new opCode("DSRAV",   "010111", 0),
   new opCode("DSRL",    "111010", 0)
   new opCode("",   "", 0)
 };
...
void start(){
  ...
  for(int i=0; i<b.length; i++){
    ...
    if(i%4==3){
      output.println(hexline+"|| "+strline);
      hexline = "";
      strline = "";
    }
  }
